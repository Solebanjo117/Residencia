...
function submitRejection() {
    ...
    if (!rejectForm.comments.trim()) return;

    rejectForm.post(
        route('oficina.revisiones.status', rejectingSubmissionId.value),
        {
            preserveScroll: true,
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            <div
                class="mb-8 flex flex-col items-start gap-4 md:flex-row md:items-center md:justify-between"
            >
                <div class="flex items-center gap-4">
                    <Link
                        :href="route('oficina.revisiones')"
                        class="rounded-lg border border-slate-200 bg-white p-2 text-slate-400 hover:bg-slate-50 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-none"
                    >
            ...
            <div class="space-y-8">
                ...
                >
                    <div
                        class="flex flex-col justify-between gap-4 border-b border-slate-200 bg-slate-50/50 px-6 py-4 sm:flex-row sm:items-center"
                    >
                        <div>
                    ...
                    <div class="px-6 py-5">
                        <div
                            v-if="
                                !load.submissions ||
                                load.submissions.length === 0
                            "
                            class="py-6 text-center"
                        >
                            <p class="text-sm text-slate-500">
                                No hay envios registrados para este grupo.
                            </p>
                        </div>
                                ...
                                >
                                    <div class="flex-1">
                                        ...
                                        >
                                            ...
                                            <span
                                                v-if="sub.submitted_late"
                                                class="inline-flex items-center rounded-full bg-amber-100 px-2.5 py-0.5 text-xs font-semibold text-amber-800 ring-1 ring-amber-200 ring-inset"
                                            >
                                                Extemporanea
                                            </span>
                                            <span
                                                v-if="sub.final_approved_at"
                                                class="inline-flex items-center rounded-full bg-emerald-100 px-2.5 py-0.5 text-xs font-semibold text-emerald-800 ring-1 ring-emerald-200 ring-inset"
                                            >
                                                Liberada
                                            </span>
                                        </div>
                                        <p class="text-sm text-slate-600">
                                            {{ sub.evidence_item.description }}
                                        </p>
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <div class="mt-1 font-medium">
                                                    {{
                                                        sub.office_reviewer.name
                                                    }}
                                                </div>
                                                <div class="text-xs">
                                                    {{ sub.office_reviewed_at }}
                                                </div>
                                            </div>
                                            <div
                                                v-if="sub.final_approver"
                                            ...
                                            >
                                                ...
                                                <div class="mt-1 font-medium">
                                                    {{
                                                        sub.final_approver.name
                                                    }}
                                                </div>
                                                <div class="text-xs">
                                                    {{ sub.final_approved_at }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div
                                        class="mt-4 flex flex-col justify-center border-t border-slate-100 pt-4 lg:mt-0 lg:w-72 lg:border-t-0 lg:border-l lg:pt-0 lg:pl-6"
                                    >
                                        <div
                                        ...
                                        >
                                            ...
                                            <button
                                                ...
                                                class="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-white px-4 py-2 text-sm font-semibold text-rose-600 shadow-sm ring-1 ring-rose-300 ring-inset hover:bg-rose-50"
                                            >
                                        ...
                                        >
                                            ...
                                            >
                                                Pendiente de visto bueno final.
                                            </p>
                                        </div>
                                        <div
                                            v-else-if="
                                        ...
                                        >
                                            <AlertTriangle
                                                class="mx-auto mb-2 h-8 w-8 text-rose-500"
                                            />
                                            <p
                                            ...
                                            <p
                                                class="mt-1 text-xs leading-tight text-rose-500"
                                            >
                                                El docente fue notificado para
                                                corregir.
                                            </p>
                                        </div>
                                        <div
        ...
        >
            <div
                class="bg-opacity-75 fixed inset-0 bg-slate-500 transition-opacity"
            ></div>
                        ...
                        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div class="sm:flex sm:items-start">
                                ...
                                >
                                    <h3
                                        id="modal-title"
                                        class="text-base leading-6 font-semibold text-slate-900"
                                    >
                                        Motivo de rechazo
                                    </h3>
                                    <div
                                        class="mt-2 mb-4 text-sm text-slate-500"
                                    >
                                        Describe por que esta evidencia no es
                                        valida. El sistema habilitara reenvio
                                        por el docente.
                                    </div>
                                    ...
                                    <textarea
                                        ...
                                        rows="4"
                                        class="block w-full rounded-md border-0 py-1.5 text-slate-900 shadow-sm ring-1 ring-slate-300 ring-inset placeholder:text-slate-400 focus:ring-2 focus:ring-rose-600 focus:ring-inset sm:text-sm sm:leading-6"
