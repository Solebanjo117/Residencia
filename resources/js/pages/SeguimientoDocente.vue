...
const canManageApplicability = computed(() =>
    ['JEFE_OFICINA', 'JEFE_DEPTO'].includes(props.userRole),
);
...
const orderedColumns = computed(() => {
    return [...props.columns].sort((a, b) => {
        const stageDiff =
            Number(a.stage_order ?? 99) - Number(b.stage_order ?? 99);
...
function exportCSV() {
    ...
    downloadBlob(
        ...
        `seguimiento_${semester.value || 'todos'}.csv`,
    );
}
...
function exportXLSX() {
    const data = filteredRows.value.map((row) => {
        ...
        orderedColumns.value.forEach((column) => {
            result[column.label.toUpperCase()] = exportStatus(
...
<template>
    <AppLayout
        :breadcrumbs="[{ title: 'Seguimiento Docente', href: '/asesorias' }]"
    >
            ...
            <div class="mx-auto max-w-full px-4 py-6 sm:px-6 lg:px-8">
                ...
                >
                    <div class="flex flex-1 items-center gap-3">
                        <div class="relative w-full max-w-2xl">
                            ...
                            />
                            <div
                                class="pointer-events-none absolute top-2.5 left-3 text-slate-400"
                            >
                                <svg
                                    width="18"
                                    height="18"
                    ...
                    <div class="relative flex items-center gap-2">
                        ...
                        <div
                            v-if="exportMenuOpen"
                            class="absolute top-11 right-0 z-20 w-44 overflow-hidden rounded-xl border border-slate-200 bg-white shadow-lg"
                        >
                            <button
                                type="button"
                ...
                >
                    <div class="overflow-x-auto">
                        <table
                            ref="printTableRef"
                            class="w-full min-w-[900px] table-auto"
                        >
                            <thead class="bg-slate-50">
                                <tr
                                    class="text-left text-[11px] font-semibold tracking-wide text-slate-600 uppercase"
                                >
                                    <th
                                        class="sticky-col-1 min-w-[160px] bg-slate-50 px-3 py-3"
                                    >
                                        Maestro
                                    </th>
                                    <th
                                        class="sticky-col-2 min-w-[150px] bg-slate-50 px-3 py-3"
                                    >
                                        Materia
                                    </th>
                            ...
                            <tbody class="divide-y divide-slate-100">
                                ...
                                >
                                    <td
                                        class="sticky-col-1 bg-white px-3 py-2 text-sm font-semibold text-slate-900"
                                    >
                                        {{ row.maestro }}
                                    </td>
                                    <td
                                        class="sticky-col-2 bg-white px-3 py-2 text-sm text-slate-800"
                                    >
                                        {{ row.materia }}
                                    </td>
                                    ...
                                    <td
                                        class="px-3 py-2 font-mono text-sm text-slate-700"
                                    >
                                        {{ row.clave_tecnm }}
                                    </td>
                                ...
                                <tr v-if="filteredRows.length === 0">
                                    <td
                                        :colspan="5 + orderedColumns.length + 2"
            ...
            <div class="w-full max-w-2xl rounded-xl bg-white shadow-xl">
                ...
                >
                    <div>
                        ...
                        <p class="text-sm text-slate-600">
                            {{ cellModalRow?.maestro }} -
                            {{ cellModalRow?.materia }}
                        </p>
                    </div>
                ...
                <div class="space-y-4 px-5 py-4">
                    <div class="flex flex-wrap items-center gap-2 text-xs">
                        ...
                        <span
                            v-if="cellModalData.is_late"
                            class="rounded-full border border-amber-200 bg-amber-50 px-2 py-1 font-semibold text-amber-700"
                        >
                    ...
                    >
                        <div
                            v-if="cellModalData.office_approved_at"
                        ...
                        >
                            ...
                            <div class="mt-1 font-medium">
                                {{
                                    cellModalData.office_approved_by ||
                                    'Sin nombre'
                                }}
                            </div>
                            <div class="text-xs">
                        ...
                        <div
                            v-if="cellModalData.final_approved_at"
                        ...
                        >
                            ...
                            <div class="mt-1 font-medium">
                                {{
                                    cellModalData.final_approved_by ||
                                    'Sin nombre'
                                }}
                            </div>
                            <div class="text-xs">
                    ...
                    <div>
                        ...
                        <div
                            v-if="cellModalData.files.length === 0"
                        ...
                        <ul v-else class="space-y-2">
                            <li
                                v-for="file in cellModalData.files"
                                :key="file.id"
                    ...
                    <div
                        v-if="cellModalData.review_trail?.length"
                    ...
                    >
                        ...
                        <ul class="space-y-2">
                            <li
                                v-for="review in cellModalData.review_trail"
                                :key="`${review.stage}-${review.reviewed_at}`"
                                class="rounded-lg border border-white bg-white px-3 py-2 text-sm"
                            >
                    ...
                    >
                        ...
                        <div class="grid gap-2 sm:grid-cols-2">
                            <label
                                ...
                                :class="
                                    cellStatusForm.status === option.value
                    ...
                    <div
                        v-if="
                            canOfficeReview && cellModalData.can_office_review
                        "
                        class="rounded-lg border border-slate-100 p-3"
                    >
                        <h3
                    ...
                    <div
                        v-if="
                            canFinalApprove && cellModalData.can_final_approve
                        "
                        class="rounded-lg border border-slate-100 p-3"
                    >
                        <h3
                        ...
                        <div class="mt-3 flex items-center gap-2">
                            <button
                                ...
                                :disabled="finalApprovalForm.processing"
                    ...
                    <div
                        v-if="
                            cellModalData.status === 'NE' &&
                            cellModalData.files.length === 0
                        "
            ...
            <div class="w-full max-w-xl rounded-xl bg-white shadow-xl">
                ...
                >
                    ...
                    <span
                        ...
                        :class="
                            departmentReviewPillClasses(
                                departmentReviewRow.department_review?.status,
                            )
                        "
                    >
                        {{
                ...
                <div class="space-y-4 px-5 py-4">
                    ...
                    >
                        ...
                        <ul class="space-y-2">
                            <li
                                v-for="review in departmentReviewRow
                                    .department_review.trail"
                                :key="`${review.decision}-${review.reviewed_at}`"
                                class="rounded-lg border border-white bg-white px-3 py-2 text-sm"
                            >
                                <div class="flex flex-wrap items-center gap-2">
                                    <span
                    ...
                    <div
                        v-if="departmentReviewRow.department_review?.can_review"
                        class="rounded-lg border border-slate-100 p-3"
                    >
                        <h3
                            class="mb-2 text-xs font-semibold text-slate-500 uppercase"
                        ...
                        <div class="mt-3 flex items-center gap-2">
                            <button
                                ...
                                @click="submitDepartmentReview('APPROVE')"
                            >
                                Aprobar
                            </button>
                            <button
                    ...
                    >
                        Solo el jefe de departamento puede registrar esta
