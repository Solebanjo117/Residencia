...
const docenteRole = computed(() =>
    props.roles.find((role) => role.name === 'DOCENTE'),
);
const isDocenteRoleSelected = computed(
    () => form.role_id === docenteRole.value?.id,
);
        ...
        <div class="mx-auto max-w-7xl px-6 py-8">
            <div class="mb-6 flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Crea cuentas de acceso, asigna roles, departamentos y
                        relaciona cuentas administrativas con un docente si
                        aplica.
                    </p>
                </div>
                <button
                            ...
                            <td class="px-6 py-4 text-sm text-gray-700">
                                <template v-if="user.linked_teacher">
                                    <div class="font-medium">
                                        {{ user.linked_teacher.name }}
                                    </div>
                                    <div class="text-xs text-gray-500">
                                        {{ user.linked_teacher.email }}
                                    </div>
                                </template>
                                <span
                                    v-else
            ...
            >
                ...
                >
                    ...
                    <div
                        class="relative transform overflow-hidden rounded-xl bg-white text-left shadow-xl sm:my-8 sm:w-full sm:max-w-lg"
                    >
                            ...
                            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div v-if="!isDocenteRoleSelected">
                                        <label
                                            for="user-linked-teacher"
                                            class="block text-sm font-medium text-gray-700"
                                            >Docente asociado (opcional)</label
                                        >
                                        <select
                                            id="user-linked-teacher"
                                            v-model="
                                                form.linked_teacher_user_id
                                            "
                                            class="mt-1 block w-full rounded-md border-gray-300 sm:text-sm"
                                        >
                                            <option :value="null">
                                                Sin docente asociado
                                            </option>
                                            <option
                                        ...
                                        <p class="mt-1 text-xs text-gray-500">
                                            Si el rol es Docente, la cuenta ya
                                            representa directamente al docente.
                                        </p>
                                        <div
                                            v-if="
                                                form.errors
