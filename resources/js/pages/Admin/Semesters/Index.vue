...
<template>
            ...
            <div class="mb-6 flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-muted-foreground">
                        Configura los semestres globales y su vigencia
                        institucional.
                    </p>
                </div>
                            ...
                            >
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <Badge
                                        ...
                                        variant="success"
                                    >
                                        <CalendarHeart class="mr-1 h-3 w-3" />
                                        ABIERTO
                                    </Badge>
                                    <Badge v-else variant="destructive">
                                        <CalendarOff class="mr-1 h-3 w-3" />
                                        CERRADO
                                    </Badge>
                                </td>
                                <td
                                ...
                                >
                                    <div class="flex justify-end gap-2">
                                        ...
                                        <Button
                                            ...
                                            @click="requestDelete(semester.id)"
                                        >
    ...
    >
        <DialogContent class="sm:max-w-lg">
            <DialogHeader>
                <DialogTitle>{{
                    editingSemester ? 'Editar Semestre' : 'Crear Semestre'
                }}</DialogTitle>
            ...
            <form @submit.prevent="submitForm" class="space-y-4">
                ...
                <div>
                    ...
                    <p class="mt-2 text-xs text-muted-foreground">
                        Solo puede haber un semestre activo a la vez. Si marcas
                        este semestre como abierto, el sistema cerrará
                        automáticamente cualquier otro semestre activo.
                    </p>
                </div>
            </form>
