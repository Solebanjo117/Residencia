...
const activeSemesterId = computed(() => {
    const activeSemester = props.semesters.find(
...
const destroyLoad = (id: number) => {
    if (
        confirm('¿Seguro que deseas eliminar esta asignación de carga docente?')
    ) {
...
<template>
    ...
    >
        <div class="mx-auto max-w-7xl px-6 py-8">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                        ...
                        <tr v-if="teachingLoads.data.length === 0">
                            ...
                            >
                                No se encontraron cargas académicas para este
                                filtro.
                            </td>
                        </tr>
                    </tbody>
            ...
            <div
                v-if="teachingLoads.links.length > 3"
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-1 text-xs text-gray-500">
                                            Las materias en línea pueden usar
                                            ventanas de entrega especiales más
                                            amplias.
                                        </p>
                                        <div
