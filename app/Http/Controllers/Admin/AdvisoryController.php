            ...
            foreach ($requirements as $requirement) {
                ...
                $rowData['cells']['item_'.$item->id] = [
                    ...
                    'files' => $cellFiles->map(fn (array $entry) => [
                        ...
                        'is_docx' => $entry[0]->isDocx(),
                        'docx_editor_url' => $entry[0]->isDocx() ? route('files.docx.show', $entry[0]->id, false) : null,
                        'can_edit_docx' => $entry[0]->isDocx() && $user->can('replace', $entry[0]),
                        'can_replace' => $user->can('replace', $entry[0]),
